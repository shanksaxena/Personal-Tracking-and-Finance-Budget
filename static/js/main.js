...
(function () {
  ...
  function updateExpenseChart() {
    ...
    if (!expenseData || !expenseData.labels || expenseData.labels.length === 0 || !expenseData.data || expenseData.data.length === 0) {
      expenseChartCanvas.style.display = 'none'; // Hide the chart
      return;
    } else {
      expenseChartCanvas.style.display = 'block'; // Show the chart
    }
    ...
    const chartWidth = expenseChartCanvas.parentElement.offsetWidth;
    const chartHeight = 300;

    // Set the canvas dimensions
    expenseChartCanvas.width = chartWidth;
    expenseChartCanvas.height = chartHeight;
    // Create new chart
